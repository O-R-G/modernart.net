...
function displayTime() {
	...
	var datestring = serverdate.getDate() + " " + montharray[serverdate.getMonth()] + " " + padlength(serverdate.getFullYear());
...
// on pages with images, show swipe box when page is fully loaded
