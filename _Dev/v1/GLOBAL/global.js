...
//  Show next child in nested divs

function nextChildShow(parentDiv, nextChildStub) {

	// Get all children -- strict XML means even spaces count
	// use: nextChild = nextChildShow('parentDivIdHere', nextChild);
	// returns null when finished with children
	
	parent = document.getElementById(parentDiv);
	children = parent.childNodes;
	
	if ( nextChildStub < children.length ) {
	
		children[nextChildStub].style.visibility = 'visible';
		nextChildStub++;
		return nextChildStub; 
